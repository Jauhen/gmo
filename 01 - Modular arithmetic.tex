  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.5\textwidth}
      ...
      \begin{wrapfigure}{l}{0.4\textwidth}
        \vspace*{-0.8em}
        \hspace*{-1.6em}
        \includegraphics[width=0.5\textwidth]{01 - Modular arithmetic/collab.png}
      \end{wrapfigure}
      \textbf{coprime} (\emph{coprime numbers are numbers that don't have common divisors}) factors. 
