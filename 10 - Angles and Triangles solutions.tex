...
\begin{frame}{Challenge problem 3}
  \begin{columns}[T]
    ...
    \begin{column}{0.5\textwidth}
      ...
      Note that $\triangle ABC$ and $\triangle FBE$ are similar, so $\frac{BF}{FE} = \dfrac{AB}{AC}$. This can be written as $\dfrac{4-x}{x}=\dfrac{4}{3}$. Solving, $x = \dfrac{12}{7}$.
...
\begin{frame}{Team attack 4 solutions, problems 1-2}
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      ...
      Therefore her average speed in km/hr is $\dfrac{2}{\frac{2}{3}}=\boxed{3}$.
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{problem}
...
\begin{frame}{Team attack 4 solutions, problems 3-4}
  \begin{columns}[T]
    ...
    \begin{column}{0.5\textwidth}
      ...
      \end{problem}
      Notice that $1 \cdot 60=2 \cdot 30=3 \cdot 20=4 \cdot 15=5 \cdot 12=6 \cdot 10=60$. Hence, $60$ has $12$ factors, of which $6$ are less than $7$. Thus, the answer is $\dfrac{6}{12} = \boxed{\dfrac{1}{2}}$.
