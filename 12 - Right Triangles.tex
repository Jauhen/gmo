  ...
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \begin{enumerate}
        ...
        \item In rectangle $PQRS$, $PQ=8$ and $QR=6$. Points $A$ and $B$ lie on $\overline{PQ}$, points $C$ and $D$ lie on $\overline{QR}$, points $E$ and $F$ lie on $\overline{RS}$, and points $G$ and $H$ lie on $\overline{SP}$ so that $AP=BQ<4$ and the convex octagon $ABCDEFGH$ is equilateral. Find the length of a side of this octagon. % 2018 AMC 10B Problems/Problem 17
      \end{enumerate}
    \end{column}
    \begin{column}{0.5\textwidth}
    \end{column}
