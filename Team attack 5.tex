...
\begin{document}
  ...
  \begin{enumerate}[leftmargin=3mm]
    ...
    \item Suppose $\dfrac{2}{N}$, $\dfrac{3}{N}$, and $\dfrac{5}{N}$ are three fractions in lowest terms. What are all the possible composite whole number values for $N$ between $20$ and $80$? % Set 9, 2D
